...
This is a **[Rhino](https://appsilon.github.io/rhino/)-based R Shiny application** called `rap` (Appsilon's opinionated Shiny app framework).
...
- **Config**: `config.yml` for environment-based configuration, `renv.lock` for package management
- **Testing**:
